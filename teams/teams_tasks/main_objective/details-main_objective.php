    ...
    <div class="organizer_wrapper">
      ...
      <?php foreach ($medium_objective as $medium_objective_data): ?>
        <?php
          ...
          <?php
            $additional_objective = $db->run("SELECT * FROM teams_additional_objectives WHERE teams_medium_objectives_id = ?", [$medium_objective_data->id])->fetchAll(PDO::FETCH_CLASS, "AdditionalObjective");
          ?>
